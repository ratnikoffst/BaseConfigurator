...
public class FTDriver {
    ...
    public boolean begin(int baudrate) {
        ...
        isCDC = mDevice.getDeviceClass() == UsbConstants.USB_CLASS_COMM;
    ...
    // Проверка коннекта конечных точек
    public boolean isConnected() {
        return mDevice != null && mFTDIEndpointIN != null
...
// Установка типа работы
    ...
    private boolean getCdcEndpoint() {
        ...
        return !(mFTDIEndpointIN == null || mFTDIEndpointOUT == null);
